...
public class Proj01_Main
{
    public static void main( String[] args )
    {
        ...
        switch ( args[ 0 ].toLowerCase() ) {
            case "bubblesort":
                sort = new Proj01_BubbleSort( debug );
                break;
            case "insertionsort":
                sort = new Proj01_InsertionSort( debug );
                break;
            case "selectionsort":
                sort = new Proj01_SelectionSort( debug );
                break;
            case "mergesort":
                sort = new Proj01_MergeSort( debug, baseLen );
                break;
            case "quicksort":
                sort = new Proj01_QuickSort( debug, mode, baseLen );
                break;
